            ...
            <form
                ...
                <div className="md:inline-flex space-y-4 md:space-y-0  w-full p-4 items-center">
                    <div className="md:w-2/3 mx-auto max-w-sm space-y-5">
                        <div>
                            ...
                            <label className="text-sm md:text-lg">Email*
                            ...
                            <label className="text-sm md:text-lg">{data.name}*
                            <div className="w-full inline-flex border">
                ...
                <div>
                    <div className="md:w-2/3 mx-auto max-w-sm">
                        <div>
                            <label className="text-sm md:text-lg text-black">{data.content}
                        ...
                        <button aria-label="Send Form" className="w-full mt-2 text-gray-700 inline-flex bg-green-300 hover:bg-green-100 hover:text-green-600 p-3 rounded text-2xl font-bold">
                            <svg
                                fill="none"
                                className="w-4 mr-2"
                                viewBox="0 0 24 24"
