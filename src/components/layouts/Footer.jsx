            ...
            <div className="container mx-auto">
                <div className="mt-16 border-t-2 border-green-300 grid grid-cols-1 sm:grid-cols-3 items-center">
                    ...
                    <div className="text-center py-6 flex justify-between items-center">
                        ...
                        <a className="uppercase p-1 lg:p-6 flex items-center border border-green-600 text-green-600 max-w-max shadow-sm hover:shadow-lg rounded-full h-12" href={cv} target="_blank" rel="noopener noreferrer">
                            {data.download}
